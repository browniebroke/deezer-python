...
class AsyncUser(AsyncResource):
    ...
    async def get_followers(self, **kwargs) -> list:
        """Get user's followers."""
        return await self.get_relation("followers", **kwargs)

    async def get_followings(self, **kwargs) -> list:
        """Get user's followings."""
        return await self.get_relation("followings", **kwargs)
